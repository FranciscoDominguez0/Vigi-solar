    ...
    <footer className="bg-primary pt-20 pb-10 border-t border-gray-900">
      <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:info@vigitecpanama.com" className="hover:text-white transition-colors">
        ...
        <div className="text-center text-sm text-gray-600">
          <p>&copy; {new Date().getFullYear()} Vigi-Solar. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
